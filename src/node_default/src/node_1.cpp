...
// Node_1 클래스 선언, rclcpp::Node를 상속받아 ROS2 노드로 동작
class Node_1 : public rclcpp::Node {
public:
    // 생성자: 노드 이름을 "Node_1"로 지정하고, 시작 메시지 출력
    Node_1() : Node("Node_1") {
        RCLCPP_INFO(get_logger(), "Node_1 Start!"); // 로그로 노드 시작 알림
    }
...
int main(int argc, char** argv) {
    ...
    auto node = std::make_shared<Node_1>();          // Node_1 객체 생성 (shared_ptr)
