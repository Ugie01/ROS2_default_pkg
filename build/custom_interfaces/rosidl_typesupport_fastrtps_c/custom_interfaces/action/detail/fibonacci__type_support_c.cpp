...
// already included above
// #include "rosidl_runtime_c/primitives_sequence.h"  // partial
// already included above
// #include "rosidl_runtime_c/primitives_sequence_functions.h"  // partial
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: partial
  {
    size_t size = ros_message->partial.size;
    auto array_ptr = ros_message->partial.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: partial
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->partial.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->partial);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->partial, size)) {
      fprintf(stderr, "failed to create array for field 'partial'");
      return false;
    }
    auto array_ptr = ros_message->partial.data;
    cdr.deserializeArray(array_ptr, size);
  ...
  size_t current_alignment)
{
  ...
  // field.name partial
  {
    size_t array_size = ros_message->partial.size;
    auto array_ptr = ros_message->partial.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
